...
answer_msg( #mqtt_connect_variable_header_v4{}=Msg, State )->
	...
	Stats1 = State#mqtt_processor_state.stats#mqtt_connection_stats{ client_identifier = Msg#mqtt_connect_variable_header_v4.client_identifier },
...
answer_msg( #mqtt_connect_variable_header_v5{}=Msg, State )->
	...
	_Result = (State#mqtt_processor_state.module):send(State#mqtt_processor_state.socket,Blob),
	%% io:format("Sending CONNECT response(~p): ~p~n",[Result,Blob]),
	Stats1 = State#mqtt_processor_state.stats#mqtt_connection_stats{ client_identifier = Msg#mqtt_connect_variable_header_v5.client_identifier },
	Stats2 = ?INCREMENT_STATS2(Stats1,msg_connect,msg_connack),
